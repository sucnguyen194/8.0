                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-4 mb-lg-0 mb-md-0">
                                ...
                                <div class="mb-2 mb-lg-0 mb-md-0">
                                    ...
                                    <a class="btn btn-default waves-effect waves-light" href="{{route('admin.products.videos.index')}}"><span class="icon-button"><i class="fe-arrow-left"></i></span> Quay lại</a>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card-box table-responsive">
                    <form method="post" action="{{route('admin.products.delete')}}" enctype="multipart/form-data">
                        ...
                        <div class="action-datatable mb-3">
                            ...
                            <a href="{{route('admin.products.videos.create')}}" class="btn btn-primary waves-effect float-right width-md waves-light">
                        ...
                        <table id="datatable-buttons" class="table table-bordered table-hover bs-table" style="border-collapse: collapse; border-spacing: 0; ;">
                            ...
                            @foreach($videos as $item)
                                <tr>
                                    ...
                                    <td style="width: 30%"><a href="{{route('alias',$item->alias)}}" title="{{$item->name}}" target="_blank">{{ $item->name}}</a> </td>
                                    ...
                                    <td>
                                        <a href="{{route('admin.products.videos.edit',$item)}}" class="btn btn-primary waves-effect waves-light">
