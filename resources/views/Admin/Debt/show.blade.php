                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.debts.index')}}">Danh sách NCC</a></li>
                            <li class="breadcrumb-item active">Biển động số dư #{{$debt->id}}</li>
                        </ol>
                    </div>
                    <h4 class="page-title">#{{$debt->name}}</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-2 mb-lg-0 mb-md-0">
                                    ...
                                    <a class="btn btn-default waves-effect waves-light" href="{{route('admin.debts.show',$debt)}}"><span class="icon-button"><i class="fe-arrow-left"></i></span> Quay lại</a>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="col-12">
                <div class="card-box table-responsive">
                    <div class="action-datatable text-right mb-3">
                        <a href="{{route('admin.debts.index')}}" class="btn btn-default waves-effect waves-light">
