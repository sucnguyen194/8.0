                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">#ID {{$lang->id}}</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Sửa ngôn ngữ #{{$lang->id}}</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                ...
                <div class="col-md-12">
                    <div class="card-box">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{$lang->name ?? old('name')}}" name="name" required>
                        </div>
                        <div class="form-group">
                            <label>Giá trị <span class="required">*</span></label>
                            <p>* Ghi chú: Giới hạn tối đa 2 ký tự</p>
                            <input type="text" maxlength="2" value="{{$lang->value ?? old('value')}}" name="value" class="form-control" id="alloptions" />
                        </div>
                    </div>
                </div>
                <div class="col-lg-12">
