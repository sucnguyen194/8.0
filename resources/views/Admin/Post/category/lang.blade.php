...
@section('content')
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{$category->route}}">Danh mục bài viết</a></li>
                            <li class="breadcrumb-item active">Thêm mới</li>

                        </ol>
                    </div>
                    <h4 class="page-title">{{$category->name}} <small>({{$language}})</small> </h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
    ...
    <div class="container">
        <form method="post" action="{{route('admin.categories.add',[$language, $category->id])}}" enctype="multipart/form-data">
            <div class="row">
            @csrf
            <div class="col-lg-8">
                <div class="card-box">
            ...
            <div class="col-lg-12">
                <input type="hidden" name="data[type]" value="{{\App\Enums\CategoryType::POST_CATEGORY}}">
