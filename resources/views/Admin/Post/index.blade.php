                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-4 mb-lg-0 mb-md-2">
                                ...
                                <select class="form-control" data-toggle="select2" name="category">
                                    ...
                                    @foreach($category->where('parent_id', 0) as $item )
                                        <option value="{{$item->id}}" {{request()->category == $item->id ? "selected" : ""}} class="font-weight-bold">{{$item->title}}</option>
                            ...
                            <div class="col-lg-2 col-md-4 mb-lg-0 mb-md-2">
                                ...
                                <div class="mb-2 mb-lg-0 mb-md-0">
                                    ...
                                    <a class="btn btn-default waves-effect waves-light" href="{{route('admin.posts.index')}}"><span class="icon-button"><i class="fe-arrow-left"></i></span> Quay lại</a>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card-box table-responsive">
                    <form method="post" action="{{route('admin.posts.delete')}}" enctype="multipart/form-data">
                        ...
                        <div class="action-datatable mb-3">
                            ...
                            <a href="{{route('admin.posts.create')}}" class="btn btn-primary waves-effect width-md waves-light float-right">
                        ...
                        <table id="datatable-buttons" class="table table-bordered table-hover bs-table" style="border-collapse: collapse; border-spacing: 0; ;">
                            ...
                            @foreach($posts as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.posts.edit',$item)}}" class="btn btn-primary waves-effect waves-light">
