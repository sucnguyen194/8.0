                            ...
                            <div class="account-content mt-4">
                                <form class="form-horizontal" action="{{route('admin.login')}}" method="post">
                                    ...
                                    <div class="form-group row text-center mt-2">
                                        <div class="col-12">
                                            <button class="btn btn-md btn-block btn-primary waves-effect waves-light" type="submit">{{trans('auth.Login')}}</button>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <div class="row mt-4 pt-2">
                                    <div class="col-sm-12 text-center">
                                        <p class="text-muted mb-0">{{trans('auth.You are not account?')}} <a href="{{route('register')}}" class="text-dark ml-1"><b>{{trans('auth.Register')}}</b></a></p>
                                    </div>
                                </div>
