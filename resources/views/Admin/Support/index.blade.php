...
@section('title') Đội ngũ hỗ trợ @stop
@section('content')
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Đội ngũ hỗ trợ</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Đội ngũ hỗ trợ</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4 mb-lg-0 mb-md-0">
                                ...
                                <div class="mb-2 mb-lg-0 mb-md-0">
                                    ...
                                    <a class="btn btn-default waves-effect waves-light" href="{{route('admin.supports.index')}}"><span class="icon-button"><i class="fe-arrow-left"></i></span> Quay lại</a>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card-box table-responsive">
                    <form method="post" action="{{route('admin.supports.delete')}}" enctype="multipart/form-data">
                        ...
                        <div class="action-datatable mb-3">
                            ...
                            <a href="{{route('admin.supports.create')}}" class="btn btn-primary waves-effect width-md waves-light float-right">
                        ...
                        <table id="datatable-buttons" class="table table-bordered table-hover bs-table" style="border-collapse: collapse; border-spacing: 0; ;">
                            ...
                            @foreach($supports as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.supports.edit',$item)}}" class="btn btn-primary waves-effect waves-light">
