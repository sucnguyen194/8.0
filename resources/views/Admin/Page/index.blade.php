...
@section('content')
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-4 mb-lg-0 mb-md-0">
                                ...
                                <div class="mb-2 mb-lg-0 mb-md-0">
                                    ...
                                    <a class="btn btn-default waves-effect waves-light" href="{{route('admin.posts.pages.index')}}"><span class="icon-button"><i class="fe-arrow-left"></i></span> Quay lại</a>
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                    <form method="post" action="{{route('admin.posts.delete')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="action-datatable mb-3">
                            ...
                            <a href="{{route('admin.posts.pages.create')}}" class="btn btn-primary waves-effect width-md waves-light float-right">
                        ...
                        <table id="datatable-buttons" class="table table-bordered table-hover bs-table" style="border-collapse: collapse; border-spacing: 0; ;">
                            ...
                            <tr>
                                <th>
                                    <div class="checkbox">
                                        <input id="check-all" class="check_del" {{$posts->count() == 0 ? "disabled" : "" }} type="checkbox" name="checkAll">
                            ...
                            @foreach($posts as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.posts.pages.edit',$item)}}" class="btn btn-primary waves-effect waves-light">
                                            <span class="icon-button"><i class="fe-edit-2"></i></span></a>

                                        <a href="{{route('admin.posts.remove',$item->id)}}" onclick="return confirm('Bạn có chắc muốn xóa?');" class="btn btn-warning waves-effect waves-light">
    ...
    <input type="hidden" class="type" value="{{\App\Enums\SystemsModuleType::POST}}">
@stop
