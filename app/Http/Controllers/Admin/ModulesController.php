...
class ModulesController extends Controller
{
    ...
    {
        if(auth()->id() > 1) $this->authorize('modules.view');
    ...
    {
        if(auth()->id() > 1) $this->authorize('modules.create');
    ...
    {
        if(auth()->id() > 1) $this->authorize('modules.destroy');
    ...
    public function editAction($table, $id){
        if(auth()->id() > 1) $this->authorize('modules.edit');
